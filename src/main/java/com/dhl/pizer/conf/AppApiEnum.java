...
public enum AppApiEnum {
    ...
    */
    ...
    sendTaskUrl("http://192.168.1.224:7100/api/route/transportOrders/"),//发送任务的url
    queryTaskUrl("http://192.168.1.224:7100/api/route/transportOrders/"),//检查任务的url
    queryVehicleUrl("http://192.168.1.224:7100/api/route/vehicles/"),//检查车辆的url
    sendSequenceTaskUrl("http://192.168.1.224:7100/api/route/orderSequences/"),//发送运单序列的url
    cancelSequenceTaskUrl("http://192.168.1.224:7100/api/route/orderSequences/%s/markComplete"),//发送运单序列的url
    startOperation("Wait"),
    ...
    stopVehicleUrl("http://192.168.1.224:55200/v1/vehicles/");//停止车辆正在执行的任务的url get + 车辆名字
